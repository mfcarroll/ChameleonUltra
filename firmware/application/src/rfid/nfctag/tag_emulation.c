...
static tag_base_handler_map_t tag_base_map[] = {
    ...
    {TAG_SENSE_LF, TAG_TYPE_KERI,        lf_tag_data_loadcb,           lf_tag_keri_data_savecb,      lf_tag_keri_data_factory,      &m_tag_data_lf},
    ...
    {TAG_SENSE_LF, TAG_TYPE_AWID,        lf_tag_data_loadcb,           lf_tag_awid_data_savecb,      lf_tag_awid_data_factory,      &m_tag_data_lf},
    {TAG_SENSE_LF, TAG_TYPE_GPROXII,     lf_tag_data_loadcb,           lf_tag_gproxii_data_savecb,   lf_tag_gproxii_data_factory,   &m_tag_data_lf},
    {TAG_SENSE_LF, TAG_TYPE_FDXB,        lf_tag_data_loadcb,           lf_tag_fdxb_data_savecb,      lf_tag_fdxb_data_factory,      &m_tag_data_lf},
