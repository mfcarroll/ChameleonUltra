...
typedef enum {
    ...
    TAG_TYPE_AWID,
    /* ⭐ The biphase family. Like AWID it is NOT a PSK1 type and must stay out of
     * IS_PSK1_TYPE; unlike AWID its emitter uses counter_top 32, the same magnitude the
     * working ASK emitters use. */
    TAG_TYPE_GPROXII,
    // NexWatch
    TAG_TYPE_IDTECK = 310,
...
#define TAG_SPECIFIC_TYPE_LF_VALUES \
    TAG_TYPE_EM410X, TAG_TYPE_EM410X_ELECTRA, TAG_TYPE_PAC, TAG_TYPE_HID_PROX, TAG_TYPE_IOPROX, TAG_TYPE_VIKING, TAG_TYPE_JABLOTRON, TAG_TYPE_IDTECK, TAG_TYPE_INDALA, TAG_TYPE_INDALA224, TAG_TYPE_KERI, TAG_TYPE_NEXWATCH, TAG_TYPE_GALLAGHER, TAG_TYPE_SECURAKEY, TAG_TYPE_NORALSY, TAG_TYPE_AWID, TAG_TYPE_GPROXII
