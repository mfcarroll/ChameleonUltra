...
| C72 | ⛔ **Placement is NOT the explanation, and this is the first time in this project that it is not.** 39 Proxmark captures while the emulator was moved around, turned over, and lifted out of the field: in-field readings span 3.5–21.4 against a real tag's 33.85 and an empty field's 2.99, and the **best position found (21.4 = 0.63x) beats the starting position (18.8 = 0.56x) by 14%**. ⇒ The emulator tops out near 0.6x a real tag wherever it is put | 39 captures | ✓ out-of-field readings land on 3.04–3.10 against an independently measured 2.99 empty floor, which validates the sweep | — | L74 |
